...
from core.data.colmap_loader import (
    qvec2rotmat,
...
from core.data.reader import Reader, sample, split_hold
from core.utils.camera_utils import focal2fov
        ...
        if self.mask_subdir is not None:
            if self.mask_subdir == "object_mask":
                ...
                if masks_path.exists():
                    ...
                    print(f"[ WARNING ] Mask {masks_path} does not exist. Skipping masks for this view.")
