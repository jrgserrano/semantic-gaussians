...
from core.data.blender_reader import BlenderReader
from core.data.colmap_loader import read_points3D_binary, read_points3D_text
from core.data.colmap_reader import ColmapReader
from core.data.nerfstudio_reader import NerfStudioReader
from core.data.polycam_reader import PolycamReader
from core.data.replica_reader import ReplicaReader
from core.data.scannet_reader import ScanNetReader
from core.data.reader import Reader
from core.params import ModelParams
from core.utils.scene_utils import (
    BasicPointCloud,
    SceneInfo,
    fetch_ply,
...
def load_scene_info(model_params: ModelParams, progbar: bool = True) -> SceneInfo:
    ...
    if (source_path / "sparse").exists():
        ...
        with open(source_path / "transforms.json") as _f:
            _meta = json.load(_f)
        # Check for NeRFStudio (ScanNet++) data set
